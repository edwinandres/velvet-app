...
class IndexArticulo extends React.Component
{   
    static defaultProps = { 
        urlService : process.env.REACT_APP_URL_SERVICES + '/articulo/',
        urlBase : '/articulo/',
        arrayColums: ['idArticulo', 'nombre', 'codigoDANE'],
    };    
        ...
        return (
                <div className="content-wrapper">
                    <section className="content-header">
                        ...
                        <ContentHeaderComponent mainTitle={"Articulo"}></ContentHeaderComponent>
                        </div>
                    </section>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h3 className="card-title">Listado Articulo</h3>
                        </div>
