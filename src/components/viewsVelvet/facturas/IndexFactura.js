...
class IndexFactura extends React.Component
{   
    static defaultProps = { 
        urlService : process.env.REACT_APP_URL_SERVICES + '/factura/',
        urlBase : '/factura/',
        arrayColums: ['total', 'fecha', 'cliente'],
    };    
        ...
        return (
                <div className="content-wrapper">
                    <section className="content-header">
                        ...
                        <ContentHeaderComponent mainTitle={"Factura"}></ContentHeaderComponent>
                        </div>
                    </section>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h3 className="card-title">Listado Facturas</h3>
                        </div>
